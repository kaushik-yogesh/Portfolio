  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          This portfolio highlights the projects I have built to date. I am
          currently developing an additional project, which is in progress and
          will be included here once completed.
        </motion.p>
      </div>
