      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img
            ...
            alt="logo"
            loading="lazy"
            className="w-16 object-contain rounded-full border border-3 border-[#6706e6] "
            width={64}
            height={64}
          />
          <p className="text-white text-[27px] font-semibold cursor-pointer">
            <span className="sm:block  font-bold">Yogesh Kaushik</span>
          </p>
        </Link>
